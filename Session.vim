...
set shortmess=aoO
badd +8 app/containers/Documents/Documents.js
badd +0 app/containers/Documents/index.js
badd +0 package.json
badd +1 app/components
argglobal
silent! argdel *
set stal=2
edit app/containers/Documents/index.js
...
exe 'vert 1resize ' . ((&columns * 64 + 142) / 284)
exe 'vert 2resize ' . ((&columns * 109 + 142) / 284)
exe 'vert 3resize ' . ((&columns * 109 + 142) / 284)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists('app/containers') | buffer app/containers | else | edit app/containers | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 8 - ((7 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
8
normal! 0
lcd ~/src/react-redux-boilerplate
wincmd w
argglobal
if bufexists('~/src/react-redux-boilerplate/app/containers/Documents/Documents.js') | buffer ~/src/react-redux-boilerplate/app/containers/Documents/Documents.js | else | edit ~/src/react-redux-boilerplate/app/containers/Documents/Documents.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 109 + 142) / 284)
exe 'vert 3resize ' . ((&columns * 109 + 142) / 284)
tabedit ~/src/react-redux-boilerplate/package.json
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
